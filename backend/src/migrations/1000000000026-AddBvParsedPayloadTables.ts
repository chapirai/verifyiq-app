...
export class AddBvParsedPayloadTables1000000000026 implements MigrationInterface {
      ...
      BEGIN
        ...
        LOOP
          ...
          LOOP
            ...
            VALUES (
              v_snapshot_id,
              COALESCE((SELECT max(source_index)+1 FROM bv_parsed.fi_funktionarer WHERE fi_organisation_snapshot_id = v_snapshot_id), 1),
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      DROP TABLE IF EXISTS bv_parsed.hvd_dokument CASCADE;
      DROP TABLE IF EXISTS bv_parsed.hvd_dokumentlista_snapshots CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_finansiella_rapporter CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_finansiella_rapport_arenden CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_funktionar_roller CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_funktionarer CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_organisation_names CASCADE;
      DROP TABLE IF EXISTS bv_parsed.fi_organisation_snapshots CASCADE;
      DROP TABLE IF EXISTS bv_parsed.hvd_organisation_sni CASCADE;
      DROP TABLE IF EXISTS bv_parsed.hvd_organisation_names CASCADE;
      DROP TABLE IF EXISTS bv_parsed.hvd_organisation_snapshots CASCADE;
      DROP TABLE IF EXISTS bv_parsed.parse_runs CASCADE;
