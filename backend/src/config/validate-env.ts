...
const envSchema = z.object({
  ...
  BV_BULK_AUTO_THROTTLE_ENABLED: z.enum(['true', 'false']).optional(),
  BV_BULK_AUTO_THROTTLE_MAX_PAUSE_MS: z.coerce.number().int().min(0).optional(),
  BV_BULK_AUTO_THROTTLE_MEM_WARN_MB: z.coerce.number().int().positive().optional(),
  BV_BULK_AUTO_THROTTLE_MEM_HARD_MB: z.coerce.number().int().positive().optional(),
  BV_BULK_AUTO_THROTTLE_EVENT_LOOP_WARN_MS: z.coerce.number().int().positive().optional(),
  BV_BULK_AUTO_THROTTLE_EVENT_LOOP_HARD_MS: z.coerce.number().int().positive().optional(),
