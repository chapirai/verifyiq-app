    ...
    <header className="site-divider border-b-2 border-t-0 bg-background">
      <Container className="grid h-[74px] grid-cols-[1fr_auto_1fr] items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <p className="mono-label text-[11px] text-foreground">Nordic Company Data</p>
        </div>
        <nav className="hidden items-center gap-10 md:flex">
          <a className="focus-outline mono-label border border-transparent px-1 py-1 text-[11px] text-muted-foreground hover:text-foreground" href="#features">
            Features
          </a>
          <a className="focus-outline mono-label border border-transparent px-1 py-1 text-[11px] text-muted-foreground hover:text-foreground" href="#pricing">
            Pricing
          </a>
